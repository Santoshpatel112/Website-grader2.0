...
function Content() {
  return (
    <div className="bg-gray-800 min-h-screen flex flex-col items-center rounded-2xl" >
      {/* Header Section */}
      ...
      <main className="flex flex-col md:flex-row w-full max-w-6xl bg-gray-700 text-white rounded-lg shadow-lg overflow-hidden mt-8">
        ...
        <div className="w-full md:w-1/2">
          <img src="//static.hsappstatic.net/website-grader-ui/static-1.3895/img/footerCmsFree.png" alt="Website Builder" className="w-full h-full object-cover" />
        </div>
